        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="card card-body">
                    <form method="POST" id="addUserForm" action="{{ route('user.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div>
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="xyz@abc.com" name="email" value="{{ old('email') }}" required>
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div>
                                        <input id="phonenumber" type="text" maxlength="10" minlength="10" class="form-control number @error('phonenumber') is-invalid @enderror" name="phonenumber" value="{{ old('phonenumber') }}" required>
                                        @error('phonenumber')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    <div>
                                        <select name="country_iso_code" class="form-control select2 @error('country_iso_code') is-invalid @enderror" id="country_iso_code" value="{{ old('country_iso_code') }}" required>
                                            ...
                                            <option value="{{$c->country_iso_code}}" {{$c->country_iso_code=="IN" ? "selected" : null}}>{{$c->country_name}} ( {{$c->country_iso_code}} )</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-sm-6">
                                <label for="password" class="">{{ __('Pasword') }}</label>
                                <div class="form-group">
                                    <div>
                            ...
                            <div class="col-sm-6">
                                <label for="password_confirmation" class="">{{ __('Confrm password') }}</label>
                                <div class="form-group">
                                    <div>
                                        <input id="password_confirmation" type="text" class="form-control @error('password_confirmation') is-invalid @enderror" data-rule-equalTo="#password" data-msg-equalTo="Passwords do not match. Please type the same password again" name="password_confirmation" value="{{ old('password_confirmation') }}" required>
