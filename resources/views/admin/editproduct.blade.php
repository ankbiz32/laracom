                                                        ...
                                                        <select id="attribute_id" name="attribute_id[]" class="form-control-sm form-control select2 attribute_id" data-placeholder="Select Attribute" required>
                                                            ...
                                                            <?php if (!empty($attributes)) {
                                                                foreach ($attributes as $row) { ?>
                                                                    <option value="<?php echo $row->id; ?>" <?php echo ($attr_id == $row->id) ? 'selected="selected"' : ''; ?>><?php echo $row->name; ?></option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                        </select>
                                                        <label id="attribute_id<?php echo $k; ?>-error" class="error" for="attribute_id"></label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                @if($i >= 0)
                                                    <div class="form-row attribute_detail_row attribute_row<?php echo $k; ?>">
                                                        ...
                                                        <div class="col-md-2" style="margin-top:30px;">
                                                            <a href="javascript:void(0);" class="btn text-danger btn-sm" onclick="removeAttributeDiv('attribute_row{{$k}}','{{$v->id}}');"><i class="fa fa-times"></i></a>
                                                        </div>
                                                    </div>
                                                @endif
                                            <?php $l++; ?>
...
<script>
    ...
    <?php if($attr_id){?>
        ...
        let ast = adt.filter(a => a.attribute_id == <?=$attr_id?>)
